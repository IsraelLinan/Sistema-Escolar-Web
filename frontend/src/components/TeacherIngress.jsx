    ...
    <div className="max-w-lg mx-auto">
      ...
      <div className="bg-[#1a1d27] border border-[#2e3350] rounded-2xl p-6 mb-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-[#e2e8f0] text-xl font-bold">Registro de Docentes</h2>
      ...
      <div className="bg-[#1a1d27] border border-[#2e3350] rounded-2xl p-6">
        ...
        <input
          ...
          className="w-full bg-[#22263a] border border-[#22c55e] text-[#e2e8f0] rounded-xl px-4 py-3 text-sm font-mono focus:outline-none focus:border-[#22c55e] mb-6"
        />
        ...
        <div className="flex gap-3 mb-6">
          <button
            ...
            className="flex-1 bg-[#22c55e] hover:bg-[#16a34a] text-[#0f1117] font-bold py-3 rounded-xl transition text-sm"
          >
            ▶ Registrar Ingreso
          </button>
          <button
